...
export const quizQuestions: QuizQuestion[] = [
  { question: "How do you say 'Hello' in Georgian?", options: ['გამარჯობა', 'ნახვამდის', 'მადლობა', 'კარგად'], pronunciations: ['gamarjoba', 'nakhvamdis', 'madloba', 'kargad'], correct: 0 },
  { question: "What does 'მადლობა' mean?", options: ['Goodbye', 'Hello', 'Thank you', 'Please'], pronunciations: ['nakhvamdis', 'gamarjoba', 'madloba', 'tu sheidzleba'], correct: 2 },
  { question: "How do you ask 'How much?' in Georgian?", options: ['რა დროა?', 'რამდენი ღირს?', 'სად არის?', 'როგორ ხარ?'], pronunciations: ['ra droa?', 'ramdeni ghirs?', 'sad aris?', 'rogor khar?'], correct: 1 },
  { question: "What is the Georgian word for 'water'?", options: ['ღვინო', 'წყალი', 'ჩაი', 'რძე'], pronunciations: ['ghvino', 'tskali', 'chai', 'rdze'], correct: 1 },
  { question: "How do you say 'I don't understand'?", options: ['მესმის', 'არ მესმის', 'ვთანხმდები', 'არაუშავს'], pronunciations: ['mesmis', 'ar mesmis', 'vtankhmdebi', 'araushavs'], correct: 1 },
  { question: "What does 'ბინა' mean?", options: ['House', 'Apartment', 'Room', 'Kitchen'], pronunciations: ['sakhli', 'bina', 'otakhi', 'samzareulo'], correct: 1 },
  { question: "What is 'სუფრა'?", options: ['Wine', 'Georgian feast/table', 'Dance', 'Song'], pronunciations: ['ghvino', 'supra', 'tsekva', 'simghera'], correct: 1 },
  { question: "What does 'მთა' mean?", options: ['Forest', 'River', 'Mountain', 'Lake'], pronunciations: ['tke', 'mdinare', 'mta', 'tba'], correct: 2 },
  { question: "What does 'გაუმარჯოს!' mean?", options: ['Hello!', 'Goodbye!', 'Cheers!', 'Thank you!'], pronunciations: ['gamarjoba!', 'nakhvamdis!', 'gaumarjos!', 'madloba!'], correct: 2 },
  { question: "How do you say 'Goodbye'?", options: ['გამარჯობა', 'ნახვამდის', 'მადლობა', 'ბოდიში'], pronunciations: ['gamarjoba', 'nakhvamdis', 'madloba', 'bodishi'], correct: 1 },
  { question: "What is 'ტამადა'?", options: ['Chef', 'Toastmaster', 'Waiter', 'Teacher'], pronunciations: ['mzareuli', 'tamada', 'mimtani', 'mastavlebeli'], correct: 1 },
  { question: "How do you say 'I'm hungry'?", options: ['მცივა', 'მშია', 'მწყურია', 'დაღლილი ვარ'], pronunciations: ['mtsiva', 'mshia', 'mtskuria', 'daghlili var'], correct: 1 },
  { question: "What does 'ძაღლი' mean?", options: ['Cat', 'Horse', 'Dog', 'Bird'], pronunciations: ['kata', 'tskheni', 'dzaghli', 'prinveli'], correct: 2 },
  { question: "What is the Georgian word for 'Red'?", options: ['ლურჯი', 'მწვანე', 'შავი', 'წითელი'], pronunciations: ['lurji', 'mtsvane', 'shavi', 'tsiteli'], correct: 3 },
  { question: "How do you say 'Doctor' in Georgian?", options: ['ექიმი', 'აფთიაქი', 'წამალი', 'ოსტატი'], pronunciations: ['ekimi', 'aptiaki', 'tsamali', 'ostati'], correct: 0 },
  { question: "What does 'გენაცვალე' literally mean?", options: ['My friend', 'Thank you', 'I sacrifice myself for you', 'Beautiful'], pronunciations: ['chemi megobari', 'madloba', 'genatsvalue', 'lamazi'], correct: 2 },
  { question: "How do you say 'Left' in Georgian?", options: ['მარჯვნივ', 'მარცხნივ', 'პირდაპირ', 'უკან'], pronunciations: ['marjvniv', 'martskhniv', 'pirdapir', 'ukan'], correct: 1 },
  { question: "What is 'ქვევრი'?", options: ['A type of bread', 'A clay wine vessel', 'A musical instrument', 'A mountain pass'], pronunciations: ['puris saxeoba', 'qvevri', 'sakraveli', 'ugeltexili'], correct: 1 },
  { question: "How do you say 'I love you'?", options: ['მოგწონხარ', 'მიყვარხარ', 'მეგობარი ხარ', 'ლამაზი ხარ'], pronunciations: ['mogwonkhar', 'mikvarkhar', 'megobari khar', 'lamazi khar'], correct: 1 },
  { question: "What does 'პური' mean?", options: ['Wine', 'Water', 'Bread', 'Cheese'], pronunciations: ['ghvino', 'tskali', 'puri', 'kveli'], correct: 2 },
  { question: "How do you say 'It's raining'?", options: ['თოვს', 'წვიმს', 'ცხელა', 'ცივა'], pronunciations: ['tovs', 'tsvims', 'tskhela', 'tsiva'], correct: 1 },
  { question: "What is 'ფეხბურთი'?", options: ['Basketball', 'Tennis', 'Football', 'Rugby'], pronunciations: ['kalatburti', 'tenisi', 'pekhburti', 'ragbi'], correct: 2 },
  { question: "How do you say 'Let's go!'?", options: ['მოდი!', 'წავიდეთ!', 'გაჩერდი!', 'დაიცადე!'], pronunciations: ['modi!', 'tsavidet!', 'gacherdi!', 'daitsade!'], correct: 1 },
  { question: "What does 'ახალი წელი' mean?", options: ['Birthday', 'Christmas', 'New Year', 'Wedding'], pronunciations: ['dabadebis dghe', 'shoba', 'akhali tseli', 'kortsili'], correct: 2 },
  { question: "How do you say 'WiFi password' in Georgian?", options: ['ინტერნეტი', 'ვაი-ფაის პაროლი', 'კომპიუტერი', 'ტელეფონი'], pronunciations: ['interneti', 'vai-fais paroli', 'kompiuteri', 'teleponi'], correct: 1 },
  { question: "What does 'არაუშავს' mean?", options: ['Very bad', 'No problem', 'Excuse me', 'I disagree'], pronunciations: ['dzalian tsudi', 'araushavs', 'bodishi', 'ar vtankhmdebi'], correct: 1 },
  { question: "How do you say 'Beautiful'?", options: ['დიდი', 'პატარა', 'ლამაზი', 'ძველი'], pronunciations: ['didi', 'patara', 'lamazi', 'dzveli'], correct: 2 },
  { question: "What is the emergency number in Georgia?", options: ['999', '911', '112', '100'], pronunciations: ['999', '911', '112', '100'], correct: 2 },
  { question: "What does 'ბოლომდე!' mean at a supra?", options: ['Slow down!', 'To the bottom! (drink up)', 'More wine!', 'Sit down!'], pronunciations: ['nela!', 'bolomde!', 'meti ghvino!', 'dajet!'], correct: 1 },
  { question: "How do you say 'I work remotely'?", options: ['ოფისში ვმუშაობ', 'დისტანციურად ვმუშაობ', 'არ ვმუშაობ', 'ბევრს ვმუშაობ'], pronunciations: ['opisshi vmushob', 'distantsiurad vmushob', 'ar vmushob', 'bevrs vmushob'], correct: 1 },
]
