...
export const lessons: Lesson[] = [
  ...
  {
    lesson: 26, title: 'At the Coffee Shop', georgian: 'ყავა', english: 'Coffee',
    difficulty: 'Beginner', category: 'Food', duration: '15 min',
    phrases: [
      { georgian: 'ყავა', english: 'Coffee', pronunciation: 'ka-va', difficulty: 'easy' },
      { georgian: 'ესპრესო', english: 'Espresso', pronunciation: 'es-pre-so', difficulty: 'easy' },
      { georgian: 'კაპუჩინო', english: 'Cappuccino', pronunciation: 'ka-pu-chi-no', difficulty: 'easy' },
      { georgian: 'რძიანი ყავა', english: 'Coffee with milk', pronunciation: 'rdzi-a-ni ka-va', difficulty: 'medium' },
      { georgian: 'შაქარი', english: 'Sugar', pronunciation: 'sha-ka-ri', difficulty: 'easy' },
      { georgian: 'შაქრის გარეშე', english: 'Without sugar', pronunciation: 'shak-ris ga-re-she', difficulty: 'medium' },
      { georgian: 'ცხელი', english: 'Hot', pronunciation: 'tskhe-li', difficulty: 'easy' },
      { georgian: 'ცივი', english: 'Cold/Iced', pronunciation: 'tsi-vi', difficulty: 'easy' },
      { georgian: 'წასაღები', english: 'Takeaway', pronunciation: 'tsa-sa-ghe-bi', difficulty: 'medium' },
    ],
    culturalNotes: 'Tbilisi has an incredible coffee scene. Third-wave coffee shops are everywhere, especially around Vera and Mtatsminda. Locals take their coffee seriously.',
  },
  {
    lesson: 27, title: 'Visiting Someone\'s Home', georgian: 'სტუმარი', english: 'Guest',
    difficulty: 'Intermediate', category: 'Culture', duration: '25 min',
    phrases: [
      { georgian: 'სტუმარი', english: 'Guest', pronunciation: 'stu-ma-ri', difficulty: 'easy' },
      { georgian: 'მობრძანდით!', english: 'Welcome! (Come in!)', pronunciation: 'mo-br-dzan-dit!', difficulty: 'hard' },
      { georgian: 'ჩაი თუ ყავა?', english: 'Tea or coffee?', pronunciation: 'chai tu ka-va?', difficulty: 'medium' },
      { georgian: 'ძალიან ლამაზი სახლია', english: 'Very beautiful house', pronunciation: 'dza-li-an la-ma-zi sakh-li-a', difficulty: 'hard' },
      { georgian: 'ფეხსაცმელი გავიხადო?', english: 'Should I take my shoes off?', pronunciation: 'pekh-sa-tsme-li ga-vi-kha-do?', difficulty: 'hard' },
      { georgian: 'საჩუქარი მოგიტანეთ', english: 'I brought you a gift', pronunciation: 'sa-chu-ka-ri mo-gi-ta-net', difficulty: 'hard' },
      { georgian: 'ძალიან გემრიელი იყო', english: 'It was very delicious', pronunciation: 'dza-li-an gem-ri-e-li i-ko', difficulty: 'hard' },
    ],
    culturalNotes: 'Georgians are legendary hosts. You will be fed until you physically cannot eat more. Always bring something — wine, sweets, or flowers. Refusing food is considered rude.',
  },
  {
    lesson: 28, title: 'Georgian Music & Dance', georgian: 'მუსიკა', english: 'Music',
    difficulty: 'Intermediate', category: 'Culture', duration: '20 min',
    phrases: [
      ...
      { georgian: 'მრავალჟამიერ', english: 'Traditional toast song', pronunciation: 'mra-val-zha-mi-er', difficulty: 'hard' },
      { georgian: 'პანდური', english: 'Panduri (string instrument)', pronunciation: 'pan-du-ri', difficulty: 'medium' },
      { georgian: 'ლეზგინკა', english: 'Lezginka (dance)', pronunciation: 'lez-gin-ka', difficulty: 'medium' },
      { georgian: 'ხმა', english: 'Voice', pronunciation: 'khma', difficulty: 'easy' },
      { georgian: 'მრავალხმიანობა', english: 'Polyphony', pronunciation: 'mra-val-khmi-a-no-ba', difficulty: 'hard' },
    ],
    culturalNotes: 'Georgian polyphonic singing is UNESCO-protected. It predates European harmony by centuries. At any supra, expect spontaneous group singing.',
  },
  {
    lesson: 29, title: 'Religion & Churches', georgian: 'ეკლესია', english: 'Church',
    difficulty: 'Intermediate', category: 'Culture', duration: '22 min',
    phrases: [
      { georgian: 'ეკლესია', english: 'Church', pronunciation: 'ek-le-si-a', difficulty: 'easy' },
      { georgian: 'ტაძარი', english: 'Cathedral/Temple', pronunciation: 'ta-dza-ri', difficulty: 'medium' },
      { georgian: 'მონასტერი', english: 'Monastery', pronunciation: 'mo-nas-te-ri', difficulty: 'easy' },
      { georgian: 'სანთელი', english: 'Candle', pronunciation: 'san-te-li', difficulty: 'medium' },
      { georgian: 'ხატი', english: 'Icon', pronunciation: 'kha-ti', difficulty: 'easy' },
      { georgian: 'ლოცვა', english: 'Prayer', pronunciation: 'lots-va', difficulty: 'medium' },
      { georgian: 'მართლმადიდებლური', english: 'Orthodox', pronunciation: 'mart-lma-di-deb-lu-ri', difficulty: 'hard' },
    ],
    culturalNotes: 'Georgia adopted Christianity in 337 AD — one of the first countries in the world. Churches are everywhere. Cover shoulders and knees when entering. Women should cover their heads.',
  },
  {
    lesson: 30, title: 'Travel & Sightseeing', georgian: 'მოგზაურობა', english: 'Travel',
    difficulty: 'Intermediate', category: 'Travel', duration: '28 min',
    phrases: [
      { georgian: 'მოგზაურობა', english: 'Travel', pronunciation: 'mog-zau-ro-ba', difficulty: 'medium' },
      { georgian: 'ტურისტი', english: 'Tourist', pronunciation: 'tu-ris-ti', difficulty: 'easy' },
      { georgian: 'ღირსშესანიშნაობა', english: 'Landmark/Sight', pronunciation: 'ghirs-she-sa-nish-nao-ba', difficulty: 'hard' },
      { georgian: 'ფოტო გადავიღო?', english: 'Can I take a photo?', pronunciation: 'po-to ga-da-vi-gho?', difficulty: 'medium' },
      { georgian: 'სასტუმრო', english: 'Hotel', pronunciation: 'sas-tum-ro', difficulty: 'medium' },
      { georgian: 'რეზერვაცია მაქვს', english: 'I have a reservation', pronunciation: 're-zer-va-tsi-a makvs', difficulty: 'hard' },
      ...
      { georgian: 'ძეგლი', english: 'Monument', pronunciation: 'dzeg-li', difficulty: 'medium' },
    ],
    culturalNotes: 'Georgia is compact — you can reach mountains, sea, desert, and wine regions in a single day. Marshrutkas (minibuses) go everywhere cheaply.',
  },
  {
    lesson: 31, title: 'Tbilisi Neighbourhoods', georgian: 'უბანი', english: 'Neighbourhood',
    difficulty: 'Intermediate', category: 'City', duration: '20 min',
    phrases: [
      { georgian: 'უბანი', english: 'Neighbourhood', pronunciation: 'u-ba-ni', difficulty: 'easy' },
      { georgian: 'ძველი თბილისი', english: 'Old Tbilisi', pronunciation: 'dzve-li tbi-li-si', difficulty: 'medium' },
      { georgian: 'საბურთალო', english: 'Saburtalo', pronunciation: 'sa-bur-ta-lo', difficulty: 'medium' },
      { georgian: 'ვაკე', english: 'Vake', pronunciation: 'va-ke', difficulty: 'easy' },
      { georgian: 'მთაწმინდა', english: 'Mtatsminda', pronunciation: 'm-tats-min-da', difficulty: 'hard' },
      { georgian: 'ფუნიკულიორი', english: 'Funicular', pronunciation: 'pu-ni-ku-li-o-ri', difficulty: 'medium' },
      { georgian: 'სად ცხოვრობ?', english: 'Where do you live?', pronunciation: 'sad tskho-vrob?', difficulty: 'medium' },
      { georgian: 'აბანოთუბანი', english: 'Bath district', pronunciation: 'a-ba-no-tu-ba-ni', difficulty: 'hard' },
    ],
    culturalNotes: 'Each Tbilisi neighbourhood has its own character. Vake is upscale, Saburtalo is residential, Old Tbilisi is bohemian, and Marjanishvili is the nightlife hub.',
  },
  {
    lesson: 32, title: 'Renting & Utilities', georgian: 'კომუნალური გადასახადი', english: 'Utility bill',
    difficulty: 'Advanced', category: 'Housing', duration: '30 min',
    phrases: [
      { georgian: 'ხელშეკრულება', english: 'Contract/Lease', pronunciation: 'khel-she-kru-le-ba', difficulty: 'hard' },
      { georgian: 'დეპოზიტი', english: 'Deposit', pronunciation: 'de-po-zi-ti', difficulty: 'easy' },
      { georgian: 'ელექტროენერგია', english: 'Electricity', pronunciation: 'e-lek-tro-e-ner-gi-a', difficulty: 'hard' },
      { georgian: 'გაზი', english: 'Gas', pronunciation: 'ga-zi', difficulty: 'easy' },
      { georgian: 'წყალი ჩართულია', english: 'Water is included', pronunciation: 'tska-li char-tu-li-a', difficulty: 'hard' },
      { georgian: 'გათბობა', english: 'Heating', pronunciation: 'gat-bo-ba', difficulty: 'medium' },
      { georgian: 'კონდიციონერი', english: 'Air conditioning', pronunciation: 'kon-di-tsi-o-ne-ri', difficulty: 'easy' },
      { georgian: 'სარეცხი მანქანა', english: 'Washing machine', pronunciation: 'sa-re-tskhi man-ka-na', difficulty: 'hard' },
    ],
    culturalNotes: 'Rent in Tbilisi is paid monthly in USD or GEL. Utilities are very cheap — expect 50-100 GEL/month total. Most landlords prefer cash.',
  },
  {
    lesson: 33, title: 'Georgian Cuisine Deep Dive', georgian: 'საქართველოს სამზარეულო', english: 'Georgian Kitchen',
    difficulty: 'Intermediate', category: 'Food', duration: '30 min',
    phrases: [
      { georgian: 'ლობიო', english: 'Bean stew', pronunciation: 'lo-bi-o', difficulty: 'easy' },
      { georgian: 'მწვანილი', english: 'Herbs/Greens', pronunciation: 'mts-va-ni-li', difficulty: 'medium' },
      { georgian: 'ბადრიჯანი', english: 'Aubergine/Eggplant', pronunciation: 'bad-ri-ja-ni', difficulty: 'medium' },
      { georgian: 'ჩურჩხელა', english: 'Churchkhela (grape candy)', pronunciation: 'chur-chkhe-la', difficulty: 'hard' },
      { georgian: 'ტკემალი', english: 'Plum sauce', pronunciation: 'tke-ma-li', difficulty: 'medium' },
      { georgian: 'სულგუნი', english: 'Sulguni (cheese)', pronunciation: 'sul-gu-ni', difficulty: 'medium' },
      { georgian: 'აჯიკა', english: 'Adjika (spicy paste)', pronunciation: 'a-ji-ka', difficulty: 'easy' },
      { georgian: 'ფხალი', english: 'Pkhali (vegetable pâté)', pronunciation: 'pkha-li', difficulty: 'medium' },
      { georgian: 'ოჯახური', english: 'Ojakhuri (family-style meat & potatoes)', pronunciation: 'o-ja-khu-ri', difficulty: 'medium' },
    ],
    culturalNotes: 'Georgian food is incredibly diverse by region. Megrelian food is spicier, Kakhetian is hearty with walnuts, and Adjarian is influenced by Turkish cuisine.',
  },
  {
    lesson: 34, title: 'Nightlife & Entertainment', georgian: 'გართობა', english: 'Entertainment',
    difficulty: 'Intermediate', category: 'Social', duration: '22 min',
    phrases: [
      { georgian: 'ბარი', english: 'Bar', pronunciation: 'ba-ri', difficulty: 'easy' },
      { georgian: 'კლუბი', english: 'Club', pronunciation: 'klu-bi', difficulty: 'easy' },
      { georgian: 'კონცერტი', english: 'Concert', pronunciation: 'kon-tser-ti', difficulty: 'easy' },
      { georgian: 'თეატრი', english: 'Theatre', pronunciation: 'te-at-ri', difficulty: 'easy' },
      { georgian: 'კინო', english: 'Cinema', pronunciation: 'ki-no', difficulty: 'easy' },
      { georgian: 'ვიცეკვოთ!', english: "Let's dance!", pronunciation: 'vi-tsek-vot!', difficulty: 'medium' },
      { georgian: 'სად არის კარგი ბარი?', english: 'Where is a good bar?', pronunciation: 'sad a-ris kar-gi ba-ri?', difficulty: 'medium' },
      { georgian: 'რა დროს იხურება?', english: 'What time does it close?', pronunciation: 'ra dros i-khu-re-ba?', difficulty: 'hard' },
    ],
    culturalNotes: 'Tbilisi has world-class nightlife. Bassiani and Khidi are legendary techno clubs. Bars in the old town stay open until sunrise. The scene is relaxed and inclusive.',
  },
  {
    lesson: 35, title: 'Public Services & Documents', georgian: 'დოკუმენტები', english: 'Documents',
    difficulty: 'Advanced', category: 'Admin', duration: '35 min',
    phrases: [
      { georgian: 'იუსტიციის სახლი', english: 'Public Service Hall', pronunciation: 'ius-ti-tsi-is sakh-li', difficulty: 'hard' },
      { georgian: 'ბინადრობის ნებართვა', english: 'Residence permit', pronunciation: 'bi-nad-ro-bis ne-bar-tva', difficulty: 'hard' },
      { georgian: 'პირადობის მოწმობა', english: 'ID card', pronunciation: 'pi-ra-do-bis mots-mo-ba', difficulty: 'hard' },
      { georgian: 'ნოტარიუსი', english: 'Notary', pronunciation: 'no-ta-ri-u-si', difficulty: 'easy' },
      { georgian: 'თარგმანი', english: 'Translation', pronunciation: 'tar-gma-ni', difficulty: 'medium' },
      { georgian: 'განაცხადი', english: 'Application', pronunciation: 'ga-na-tskha-di', difficulty: 'hard' },
      { georgian: 'ვადა', english: 'Deadline/Term', pronunciation: 'va-da', difficulty: 'easy' },
    ],
    culturalNotes: 'Georgia has one of the most efficient bureaucracies in the region. Public Service Hall handles everything in one place. Most processes take 1-3 days.',
  },
  {
    lesson: 36, title: 'Feelings & Opinions', georgian: 'აზრი', english: 'Opinion',
    difficulty: 'Advanced', category: 'Conversation', duration: '28 min',
    phrases: [
      { georgian: 'მგონი', english: 'I think / I guess', pronunciation: 'mgo-ni', difficulty: 'medium' },
      { georgian: 'ჩემი აზრით', english: 'In my opinion', pronunciation: 'che-mi az-rit', difficulty: 'hard' },
      { georgian: 'არ ვიცი', english: "I don't know", pronunciation: 'ar vi-tsi', difficulty: 'easy' },
      { georgian: 'დარწმუნებული ვარ', english: "I'm sure", pronunciation: 'dar-tsmu-ne-bu-li var', difficulty: 'hard' },
      { georgian: 'ეჭვი მეპარება', english: 'I have doubts', pronunciation: 'ech-vi me-pa-re-ba', difficulty: 'hard' },
      { georgian: 'მართალი ხარ', english: "You're right", pronunciation: 'mar-ta-li khar', difficulty: 'medium' },
      { georgian: 'საინტერესოა', english: "That's interesting", pronunciation: 'sa-in-te-re-so-a', difficulty: 'medium' },
      { georgian: 'სამწუხაროა', english: "That's unfortunate", pronunciation: 'sam-tsu-kha-ro-a', difficulty: 'hard' },
    ],
    culturalNotes: 'Georgians love philosophical discussions, especially over wine. Expressing opinions openly is valued, but always with respect for elders.',
  },
  {
    lesson: 37, title: 'Verbs & Actions', georgian: 'ზმნები', english: 'Verbs',
    difficulty: 'Intermediate', category: 'Grammar', duration: '30 min',
    phrases: [
      { georgian: 'მივდივარ', english: "I'm going", pronunciation: 'mi-vdi-var', difficulty: 'medium' },
      { georgian: 'მოვდივარ', english: "I'm coming", pronunciation: 'mo-vdi-var', difficulty: 'medium' },
      { georgian: 'ვჭამ', english: "I'm eating", pronunciation: 'v-cham', difficulty: 'medium' },
      { georgian: 'ვსვამ', english: "I'm drinking", pronunciation: 'v-svam', difficulty: 'medium' },
      { georgian: 'ვწერ', english: "I'm writing", pronunciation: 'v-tser', difficulty: 'medium' },
      { georgian: 'ვკითხულობ', english: "I'm reading", pronunciation: 'v-kit-khu-lob', difficulty: 'hard' },
      { georgian: 'ვლაპარაკობ', english: "I'm speaking", pronunciation: 'v-la-pa-ra-kob', difficulty: 'hard' },
      { georgian: 'ვაკეთებ', english: "I'm doing/making", pronunciation: 'va-ke-teb', difficulty: 'medium' },
      { georgian: 'მინდა', english: 'I want', pronunciation: 'min-da', difficulty: 'easy' },
      { georgian: 'შემიძლია', english: 'I can', pronunciation: 'she-midz-li-a', difficulty: 'hard' },
    ],
    culturalNotes: 'Georgian verbs are complex — they change based on subject, object, direction, and tense. The prefix "ვ-" marks first person. Start with present tense and build from there.',
  },
  {
    lesson: 38, title: 'Making Plans', georgian: 'გეგმები', english: 'Plans',
    difficulty: 'Intermediate', category: 'Conversation', duration: '22 min',
    phrases: [
      { georgian: 'რას აკეთებ ხვალ?', english: 'What are you doing tomorrow?', pronunciation: 'ras a-ke-teb khval?', difficulty: 'medium' },
      { georgian: 'თავისუფალი ხარ?', english: 'Are you free?', pronunciation: 'ta-vi-su-pa-li khar?', difficulty: 'medium' },
      { georgian: 'წავიდეთ სადმე?', english: 'Shall we go somewhere?', pronunciation: 'tsa-vi-det sad-me?', difficulty: 'medium' },
      { georgian: 'რა საათზე?', english: 'At what time?', pronunciation: 'ra sa-at-ze?', difficulty: 'medium' },
      { georgian: 'სად შევხვდეთ?', english: 'Where shall we meet?', pronunciation: 'sad shev-khv-det?', difficulty: 'hard' },
      { georgian: 'ვერ მოვალ', english: "I can't come", pronunciation: 'ver mo-val', difficulty: 'medium' },
      { georgian: 'გადავდოთ?', english: 'Shall we postpone?', pronunciation: 'ga-da-v-dot?', difficulty: 'hard' },
      { georgian: 'შეთანხმებულია!', english: "It's agreed/Deal!", pronunciation: 'she-tan-khme-bu-li-a!', difficulty: 'hard' },
    ],
    culturalNotes: 'Georgians are spontaneous — plans often change last minute and that is totally normal. "Let us meet" often means "right now". Punctuality is flexible.',
  },
  {
    lesson: 39, title: 'Describing People', georgian: 'ადამიანის აღწერა', english: 'Describing People',
    difficulty: 'Intermediate', category: 'Descriptions', duration: '25 min',
    phrases: [
      { georgian: 'მაღალი', english: 'Tall', pronunciation: 'ma-gha-li', difficulty: 'easy' },
      { georgian: 'დაბალი', english: 'Short (height)', pronunciation: 'da-ba-li', difficulty: 'easy' },
      { georgian: 'ახალგაზრდა', english: 'Young', pronunciation: 'a-khal-gaz-rda', difficulty: 'hard' },
      { georgian: 'მოხუცი', english: 'Old (person)', pronunciation: 'mo-khu-tsi', difficulty: 'medium' },
      { georgian: 'ჭკვიანი', english: 'Smart/Clever', pronunciation: 'chk-vi-a-ni', difficulty: 'hard' },
      { georgian: 'კეთილი', english: 'Kind', pronunciation: 'ke-ti-li', difficulty: 'easy' },
      { georgian: 'სასაცილო', english: 'Funny', pronunciation: 'sa-sa-tsi-lo', difficulty: 'medium' },
      { georgian: 'ძლიერი', english: 'Strong', pronunciation: 'dzli-e-ri', difficulty: 'medium' },
      { georgian: 'სანდო', english: 'Trustworthy', pronunciation: 'san-do', difficulty: 'easy' },
    ],
    culturalNotes: 'Physical compliments are common in Georgia. Calling someone "კაი ბიჭი" (good guy) or "კაი გოგო" (good girl) is a high compliment about character.',
  },
  {
    lesson: 40, title: 'Survival Georgian — The Essentials', georgian: 'აუცილებელი ფრაზები', english: 'Essential Phrases',
    difficulty: 'Beginner', category: 'Essentials', duration: '20 min',
    phrases: [
      { georgian: 'ქართულად არ ვლაპარაკობ', english: "I don't speak Georgian", pronunciation: 'kar-tu-lad ar v-la-pa-ra-kob', difficulty: 'hard' },
      { georgian: 'ინგლისური იცით?', english: 'Do you speak English?', pronunciation: 'in-gli-su-ri i-tsit?', difficulty: 'medium' },
      { georgian: 'ნელა, თუ შეიძლება', english: 'Slowly, please', pronunciation: 'ne-la, tu shei-dzle-ba', difficulty: 'medium' },
      { georgian: 'დაწერეთ, თუ შეიძლება', english: 'Write it down, please', pronunciation: 'da-tse-ret, tu shei-dzle-ba', difficulty: 'hard' },
      { georgian: 'ეს რა არის?', english: 'What is this?', pronunciation: 'es ra a-ris?', difficulty: 'easy' },
      { georgian: 'სად არის ტუალეტი?', english: 'Where is the toilet?', pronunciation: 'sad a-ris tu-a-le-ti?', difficulty: 'medium' },
      { georgian: 'მე უცხოელი ვარ', english: "I'm a foreigner", pronunciation: 'me u-tskho-e-li var', difficulty: 'medium' },
      { georgian: 'საქართველო ძალიან მომწონს', english: 'I really like Georgia', pronunciation: 'sa-kar-tve-lo dza-li-an mom-tsons', difficulty: 'hard' },
    ],
    culturalNotes: 'These phrases will get you through any situation. Georgians deeply appreciate any effort to speak their language — even "გამარჯობა" and "მადლობა" will earn you smiles and warmth.',
  },
]
